    ...
    return (
      <div className={cn("border rounded-md overflow-hidden max-w-full", className)}>
        ...
        <div className="relative">
          {/* White caret in dark mode */}
          <style>{`
            .dark .rich-text-editor-caret-white {
          ...
          <div
            ...
            onBlur={handleBlur}
            className={cn(
              "w-full p-3 text-sm bg-background focus:outline-none break-words overflow-wrap-anywhere whitespace-pre-wrap rich-text-editor-caret-white",
